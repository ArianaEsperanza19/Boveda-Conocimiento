...
La presente clase recibe un objeto json para ser decodificado y entregado como un OBJETO PDO.

Tener en cuenta que si el arreglo solo posee un elemento, hay que verificar los indices, es posible que la informacion sea accesible mediante json[0].
