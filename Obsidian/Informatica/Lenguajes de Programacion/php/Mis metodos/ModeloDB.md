Clase para manejar mas fácilmente la base de datos PDO.
...
Salida: Se recibira un objeto PDO, asi que sera necesario trabajarlo para obtener la informacion mediante fetch o fetchAll.
